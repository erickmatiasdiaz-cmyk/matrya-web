        ...
        <div className="grid items-start gap-14 lg:grid-cols-[1.05fr_1.4fr]">
                ...
                <div className="mt-10 rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm">
                  ...
                  <div className="mt-6 space-y-4">
                    {signals.map((signal) => (
                      ...
                      >
                        <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(0,240,181,0.7)]" />
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {pillars.map((pillar, index) => (
              <SectionReveal key={pillar.title} delay={index * 100} direction="up">
                <article
                  className="group relative rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-8 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-400/40 hover:shadow-[0_0_40px_rgba(0,240,181,0.12)] focus-within:border-emerald-400/40"
                  tabIndex={0}
                >
